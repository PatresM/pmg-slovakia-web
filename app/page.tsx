        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-3">
          <a href="#" className="group flex items-center">
            <Image
              ...
              width={190}
              height={80}
              className="h-auto w-[155px] mix-blend-screen brightness-110 contrast-110 drop-shadow-[0_0_22px_rgba(255,255,255,0.25)] transition duration-500 group-hover:drop-shadow-[0_0_34px_rgba(215,182,111,0.65)] md:w-[185px]"
              priority
            />
          </a>
        ...
        <div className="relative z-10 mx-auto grid min-h-[84vh] max-w-7xl items-center gap-10 md:grid-cols-[0.78fr_1.22fr]">
          <div>
            ...
            <div className="mt-9 flex flex-col gap-4 sm:flex-row">
              <a
                href="#kontakt"
                className="rounded-full bg-[#d7b66f] px-8 py-4 text-center font-bold text-black shadow-[0_0_40px_rgba(215,182,111,0.32)] hover:bg-[#f0cf86]"
              >
                Chcem ponuku
              </a>
              <a
                href="#sluzby"
                className="rounded-full border border-white/25 px-8 py-4 text-center font-bold hover:bg-white/10"
              >
                Pozrieť služby
              </a>
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-14 grid gap-6 md:grid-cols-4">
            {services.map((service) => (
              <div
                key={service.title}
                className="rounded-[2rem] border border-white/10 bg-white/[0.045] p-7 shadow-2xl backdrop-blur transition hover:-translate-y-2 hover:border-[#d7b66f]/50 hover:bg-white/[0.075]"
              >
